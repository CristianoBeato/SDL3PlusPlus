...
{
public:
    SDLIOstream( void )  : IOStream( nullptr ){}
    SDLIOstream( SDL_IOStream* iostream ) : IOStream( iostream ) {}
    SDLIOstream( const SDLIOstream &ref ) : IOStream( ref.IOStream ){}
    ~SDLIOstream( void ){}
    ...
    SDL_INLINE void*            LoadFile_IO( size_t *datasize, bool closeio) 
    {
